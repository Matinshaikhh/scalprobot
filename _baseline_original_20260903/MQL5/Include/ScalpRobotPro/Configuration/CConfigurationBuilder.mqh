...
void CConfigurationBuilder::ApplyNasdaqDefaults(SInputSnapshot &in)
  {
   ...
   in.scalp_commission_points=0.0;
   ...
   in.tier_enabled[0]=true; in.tier_target_atr[0]=0.55;
   in.tier_stop_atr[0]=0.45; in.tier_hold_seconds[0]=120;
   in.tier_win_rate[0]=0.55; in.tier_timeframe[0]=(int)PERIOD_M1;
   in.tier_enabled[1]=true; in.tier_target_atr[1]=0.70;
   in.tier_stop_atr[1]=0.70; in.tier_hold_seconds[1]=300;
   in.tier_win_rate[1]=0.58; in.tier_timeframe[1]=(int)PERIOD_M1;
   in.tier_enabled[2]=true; in.tier_target_atr[2]=1.40;
   in.tier_stop_atr[2]=0.90; in.tier_hold_seconds[2]=900;
   in.tier_win_rate[2]=0.48; in.tier_timeframe[2]=(int)PERIOD_M5;
